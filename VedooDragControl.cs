...
namespace VedooControls
{
    public class VedooDragControl : Component
    {
        ...
        private void DragForm_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (flag)
            {
                VedooDragControl.ReleaseCapture();
                VedooDragControl.SendMessage(this.SelectControl.FindForm().Handle, 161, 2, 0);
            }
            }
    }
}
